...
const Cardhome = () => {
  ...
  const cardData = [
    {
      title: t('Cards.titleFitz'),
      description: t('Cards.descriptionFitz'),
      image: Imgfitz,
      code_dressed: t('Cards.codeDressed.dressedUp'),
      url1: "https://www.fourvenues.com/es/proyectx",
      url2: "https://www.fourvenues.com/es/proyectx",
    },
    {
      title: t('Cards.titleOhmyclub'),
      description: t('Cards.descriptionOhmyclub'),
      image: Imgohmyclub,
      code_dressed: t('Cards.codeDressed.elegant'),
    ...
    },
    {
      ...
      code_dressed: t('Cards.codeDressed.casual'),
      url1: "https://shokomadrid.com/eventos/",
      url2: "https://wa.me/34601518207/",
    },
    {
